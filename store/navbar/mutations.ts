...
const mutations: MutationTree<navBarStatusType> = {
  [SET_HAMMENU_OPEN]: (state): void => {
    state.hamMenuIsActive = true;
  },
  ...
  [SET_CATEGORYLIST_OPEN]: (state): void => {
    state.categoryListIsActive = true;
  },
